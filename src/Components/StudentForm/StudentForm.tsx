	...
	return (
		<Form layout="vertical" className="form">
			<div className="form__row">
				...
				<Form.Item className="form__item">
					<label htmlFor="third-name" className="form-label">
						По-батькові
					</label>
			...
			<div className="form__row">
				...
				<Form.Item className="form__item form__input--big">
					<label htmlFor="residence-place" className="form-label">
						Місце проживання
					</label>
			...
			<div className="form__row">
				...
				<Form.Item className="form__item form__input--medium">
					<label htmlFor="father-fullname" className="form-label">
						ПІБ
					</label>
					<Input id="father-fullname" className="form__input" />
				</Form.Item>
				<Form.Item className="form__item medium-input">
					<label htmlFor="father-phone" className="form-label">
						Номер телефону
					</label>
			...
			<div className="form__row">
				...
				<Form.Item className="form__item form__input--medium">
					<label htmlFor="mother-fullname" className="form-label">
						ПІБ
					</label>
					<Input id="mother-fullname" className="form__input" />
				</Form.Item>
				<Form.Item className="form__item medium-input">
					<label htmlFor="mother-phone" className="form-label">
						Номер телефону
					</label>
